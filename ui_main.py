...
"}")
        ...
        self.label_top_info_1.setMaximumSize(QSize(16777215, 16))
        font2 = QFont()
...
"}")
        ...
        self.comboBox_product = QComboBox(self.page_sales)
        self.comboBox_product.setObjectName(u"comboBox_product")
        self.comboBox_product.setGeometry(QRect(300, 160, 291, 31))
        palette1 = QPalette()
...
#endif
        self.comboBox_product.setPalette(palette1)
        self.lineEdit_quantity = QLineEdit(self.page_sales)
        self.lineEdit_quantity.setObjectName(u"lineEdit_quantity")
        self.lineEdit_quantity.setGeometry(QRect(300, 220, 201, 31))
        self.lineEdit_price = QLineEdit(self.page_sales)
        self.lineEdit_price.setObjectName(u"lineEdit_price")
        self.lineEdit_price.setGeometry(QRect(300, 280, 191, 31))
        self.pushButton_submit = QPushButton(self.page_sales)
        self.pushButton_submit.setObjectName(u"pushButton_submit")
        self.pushButton_submit.setGeometry(QRect(680, 420, 91, 31))
        self.label_sales = QLabel(self.page_sales)
        self.label_sales.setObjectName(u"label_sales")
        self.label_sales.setGeometry(QRect(10, 10, 181, 71))
        font5 = QFont()
        font5.setFamily(u"Segoe UI")
        font5.setPointSize(40)
        self.label_sales.setFont(font5)
        self.label_sales.setStyleSheet(u"")
        self.label_sales.setAlignment(Qt.AlignCenter)
        self.dateEdit_sales = QDateEdit(self.page_sales)
        self.dateEdit_sales.setObjectName(u"dateEdit_sales")
        self.dateEdit_sales.setGeometry(QRect(300, 330, 191, 41))
        font6 = QFont()
        font6.setPointSize(13)
        font6.setBold(False)
        font6.setWeight(50)
        self.dateEdit_sales.setFont(font6)
        self.dateEdit_sales.setDateTime(QDateTime(QDate(2020, 1, 1), QTime(0, 0, 0)))
        self.dateEdit_sales.setCalendarPopup(True)
        self.comboBox_measure1 = QComboBox(self.page_sales)
        self.comboBox_measure1.addItem("")
        self.comboBox_measure1.addItem("")
        self.comboBox_measure1.setObjectName(u"comboBox_measure1")
        self.comboBox_measure1.setGeometry(QRect(520, 220, 101, 31))
        self.stackedWidget.addWidget(self.page_sales)
        self.page_items = QWidget()
        self.page_items.setObjectName(u"page_items")
        self.verticalLayout_10 = QVBoxLayout(self.page_items)
        self.verticalLayout_10.setObjectName(u"verticalLayout_10")
        self.label_products = QLabel(self.page_items)
        self.label_products.setObjectName(u"label_products")
        self.label_products.setFont(font5)
        self.label_products.setStyleSheet(u"")
        self.label_products.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)

        self.verticalLayout_10.addWidget(self.label_products)

        self.pushButton_add = QPushButton(self.page_items)
        ...
        sizePolicy5.setHeightForWidth(self.pushButton_add.sizePolicy().hasHeightForWidth())
        self.pushButton_add.setSizePolicy(sizePolicy5)
        self.pushButton_add.setMinimumSize(QSize(30, 30))
        self.pushButton_add.setMaximumSize(QSize(35, 29))
        self.pushButton_add.setStyleSheet(u"QPushButton {	\n"
"	background-image:url(:/16x16/icons/16x16/cil-plus.png);\n"
"	background-position: left center;\n"
"    background-repeat: no-repeat;\n"
"	border: none;\n"
"	border-left: 7px solid rgb(27, 29, 35);\n"
...
"QPushButton:hover {\n"
"	background-color: rgb(33, 37, 43);\n"
"	border-left: 7px solid rgb(33, 37, 43);\n"
"}\n"
"QPushButton:pressed {	\n"
"	background-color: rgb(85, 170, 255);\n"
"	border-left: 7px solid rgb(85, 170, 255);\n"
"}")

        self.verticalLayout_10.addWidget(self.pushButton_add)

        self.listWidget_products = QListWidget(self.page_items)
        self.listWidget_products.setObjectName(u"listWidget_products")

        self.verticalLayout_10.addWidget(self.listWidget_products)

        self.stackedWidget.addWidget(self.page_items)
        self.page_stock = QWidget()
        self.page_stock.setObjectName(u"page_stock")
        self.verticalLayout_19 = QVBoxLayout(self.page_stock)
        self.verticalLayout_19.setObjectName(u"verticalLayout_19")
        self.label_stock = QLabel(self.page_stock)
        self.label_stock.setObjectName(u"label_stock")
        self.label_stock.setFont(font5)
        self.label_stock.setStyleSheet(u"")
        self.label_stock.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)

        self.verticalLayout_19.addWidget(self.label_stock)

        self.listWidget = QListWidget(self.page_stock)
        ...
        self.label_history.setGeometry(QRect(0, 10, 211, 71))
        self.label_history.setFont(font5)
        self.label_history.setStyleSheet(u"")
        self.label_history.setAlignment(Qt.AlignCenter)
        self.label_fromDate = QLabel(self.page_history)
        self.label_fromDate.setObjectName(u"label_fromDate")
        self.label_fromDate.setGeometry(QRect(136, 155, 131, 31))
        font7 = QFont()
        font7.setPointSize(13)
        self.label_fromDate.setFont(font7)
        self.label_fromDate.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)
        self.label_toDate = QLabel(self.page_history)
        self.label_toDate.setObjectName(u"label_toDate")
        self.label_toDate.setGeometry(QRect(160, 250, 101, 31))
        self.label_toDate.setFont(font7)
        self.label_toDate.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)
        self.dateEdit_fromDate = QDateEdit(self.page_history)
        self.dateEdit_fromDate.setObjectName(u"dateEdit_fromDate")
        self.dateEdit_fromDate.setGeometry(QRect(280, 160, 141, 21))
        self.dateEdit_fromDate.setFont(font7)
        self.dateEdit_fromDate.setDateTime(QDateTime(QDate(2020, 1, 1), QTime(0, 0, 0)))
        self.dateEdit_fromDate.setCalendarPopup(True)
        self.dateEdit_toDate = QDateEdit(self.page_history)
        self.dateEdit_toDate.setObjectName(u"dateEdit_toDate")
        self.dateEdit_toDate.setGeometry(QRect(280, 250, 141, 31))
        self.dateEdit_toDate.setFont(font7)
        self.dateEdit_toDate.setDateTime(QDateTime(QDate(2020, 1, 1), QTime(0, 0, 0)))
        self.dateEdit_toDate.setCalendarPopup(True)
        self.pushButton_search = QPushButton(self.page_history)
        self.pushButton_search.setObjectName(u"pushButton_search")
        self.pushButton_search.setGeometry(QRect(570, 410, 80, 23))
        self.stackedWidget.addWidget(self.page_history)
        self.page_stockUpdate = QWidget()
        self.page_stockUpdate.setObjectName(u"page_stockUpdate")
        self.label_stockUpdate = QLabel(self.page_stockUpdate)
        self.label_stockUpdate.setObjectName(u"label_stockUpdate")
        self.label_stockUpdate.setGeometry(QRect(0, 0, 371, 71))
        self.label_stockUpdate.setFont(font5)
        self.label_stockUpdate.setStyleSheet(u"")
        self.label_stockUpdate.setAlignment(Qt.AlignCenter)
        self.label_stockProduct = QLabel(self.page_stockUpdate)
        self.label_stockProduct.setObjectName(u"label_stockProduct")
        self.label_stockProduct.setGeometry(QRect(150, 160, 471, 51))
        font8 = QFont()
        font8.setPointSize(15)
        self.label_stockProduct.setFont(font8)
        self.label_currentStock = QLabel(self.page_stockUpdate)
        self.label_currentStock.setObjectName(u"label_currentStock")
        self.label_currentStock.setGeometry(QRect(150, 240, 361, 51))
        self.label_currentStock.setFont(font8)
        self.label_stockAdd = QLabel(self.page_stockUpdate)
        self.label_stockAdd.setObjectName(u"label_stockAdd")
        self.label_stockAdd.setGeometry(QRect(150, 320, 121, 41))
        self.label_stockAdd.setFont(font7)
        self.lineEdit_updateStock = QLineEdit(self.page_stockUpdate)
        self.lineEdit_updateStock.setObjectName(u"lineEdit_updateStock")
        self.lineEdit_updateStock.setGeometry(QRect(270, 320, 171, 31))
        self.lineEdit_updateStock.setInputMethodHints(Qt.ImhDigitsOnly)
        self.pushButton_updateStock = QPushButton(self.page_stockUpdate)
        self.pushButton_updateStock.setObjectName(u"pushButton_updateStock")
        self.pushButton_updateStock.setGeometry(QRect(390, 420, 131, 31))
        self.stackedWidget.addWidget(self.page_stockUpdate)
        self.page_addItem = QWidget()
        self.page_addItem.setObjectName(u"page_addItem")
        self.label_addItem = QLabel(self.page_addItem)
        self.label_addItem.setObjectName(u"label_addItem")
        self.label_addItem.setGeometry(QRect(0, 0, 331, 71))
        self.label_addItem.setFont(font5)
        self.label_addItem.setStyleSheet(u"")
        self.label_addItem.setAlignment(Qt.AlignCenter)
        self.lineEdit_itemName = QLineEdit(self.page_addItem)
        self.lineEdit_itemName.setObjectName(u"lineEdit_itemName")
        self.lineEdit_itemName.setGeometry(QRect(80, 180, 291, 31))
        self.pushButton_addItem = QPushButton(self.page_addItem)
        self.pushButton_addItem.setObjectName(u"pushButton_addItem")
        self.pushButton_addItem.setGeometry(QRect(110, 310, 80, 23))
        self.comboBox_measure = QComboBox(self.page_addItem)
        self.comboBox_measure.addItem("")
        self.comboBox_measure.addItem("")
        self.comboBox_measure.setObjectName(u"comboBox_measure")
        self.comboBox_measure.setGeometry(QRect(80, 230, 161, 31))
        self.stackedWidget.addWidget(self.page_addItem)
        self.page_historyResult = QWidget()
        self.page_historyResult.setObjectName(u"page_historyResult")
        self.verticalLayout_12 = QVBoxLayout(self.page_historyResult)
        self.verticalLayout_12.setObjectName(u"verticalLayout_12")
        self.label_historyResult = QLabel(self.page_historyResult)
        self.label_historyResult.setObjectName(u"label_historyResult")
        self.label_historyResult.setFont(font5)
        self.label_historyResult.setStyleSheet(u"")
        self.label_historyResult.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)

        self.verticalLayout_12.addWidget(self.label_historyResult)

        self.tableWidget_history = QTableWidget(self.page_historyResult)
        ...
        self.tableWidget_history.setFont(font7)
        self.tableWidget_history.setStyleSheet(u"QTableWidget {	\n"
...
"}\n"
"")
        self.tableWidget_history.setFrameShape(QFrame.NoFrame)
        self.tableWidget_history.setMidLineWidth(1)
        self.tableWidget_history.setAlternatingRowColors(False)
        self.tableWidget_history.setSortingEnabled(True)
        self.tableWidget_history.setColumnCount(5)
        self.tableWidget_history.horizontalHeader().setCascadingSectionResizes(True)
        self.tableWidget_history.horizontalHeader().setMinimumSectionSize(20)
        self.tableWidget_history.horizontalHeader().setDefaultSectionSize(220)
        self.tableWidget_history.verticalHeader().setMinimumSectionSize(19)
        self.tableWidget_history.verticalHeader().setDefaultSectionSize(30)

        self.verticalLayout_12.addWidget(self.tableWidget_history)

        self.stackedWidget.addWidget(self.page_historyResult)
...
"}")
        ...
        brush18 = QBrush(QColor(39, 44, 54, 255))
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_user_icon.setText(QCoreApplication.translate("MainWindow", u"DS", None))
        self.comboBox_product.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Products", None))
        self.lineEdit_quantity.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Quantity", None))
        self.lineEdit_price.setText("")
        self.lineEdit_price.setPlaceholderText(QCoreApplication.translate("MainWindow", u"price", None))
        self.pushButton_submit.setText(QCoreApplication.translate("MainWindow", u"Submit", None))
        self.label_sales.setText(QCoreApplication.translate("MainWindow", u"Sales", None))
        self.dateEdit_sales.setDisplayFormat(QCoreApplication.translate("MainWindow", u"dd/MM/yyyy", None))
        self.comboBox_measure1.setItemText(0, QCoreApplication.translate("MainWindow", u"Pieces", None))
        self.comboBox_measure1.setItemText(1, QCoreApplication.translate("MainWindow", u"Kilogram", None))

        self.label_products.setText(QCoreApplication.translate("MainWindow", u"Products", None))
        self.pushButton_add.setText("")
        self.label_stock.setText(QCoreApplication.translate("MainWindow", u"Stock", None))
        self.label_history.setText(QCoreApplication.translate("MainWindow", u"History", None))
        self.label_fromDate.setText(QCoreApplication.translate("MainWindow", u"From Date:", None))
        self.label_toDate.setText(QCoreApplication.translate("MainWindow", u"To Date:", None))
        self.dateEdit_fromDate.setDisplayFormat(QCoreApplication.translate("MainWindow", u"dd/MM/yyyy", None))
        self.dateEdit_toDate.setDisplayFormat(QCoreApplication.translate("MainWindow", u"dd/MM/yyyy", None))
        self.pushButton_search.setText(QCoreApplication.translate("MainWindow", u"Search", None))
        self.label_stockUpdate.setText(QCoreApplication.translate("MainWindow", u"Stock Update", None))
        self.label_stockProduct.setText(QCoreApplication.translate("MainWindow", u"Product:", None))
        self.label_currentStock.setText(QCoreApplication.translate("MainWindow", u"Current Stock:", None))
        self.label_stockAdd.setText(QCoreApplication.translate("MainWindow", u"Add to Stock:", None))
        self.pushButton_updateStock.setText(QCoreApplication.translate("MainWindow", u"Update Stock", None))
        self.label_addItem.setText(QCoreApplication.translate("MainWindow", u"Add Product", None))
        self.lineEdit_itemName.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Product Name", None))
        self.pushButton_addItem.setText(QCoreApplication.translate("MainWindow", u"Add", None))
        self.comboBox_measure.setItemText(0, QCoreApplication.translate("MainWindow", u"Pieces.", None))
        self.comboBox_measure.setItemText(1, QCoreApplication.translate("MainWindow", u"Kilogram", None))

        self.label_historyResult.setText(QCoreApplication.translate("MainWindow", u"Result", None))
        ...
        self.label_credits.setText(QCoreApplication.translate("MainWindow", u"D.S Bakers", None))
